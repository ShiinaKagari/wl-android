...
fn latest_wins_replaces_pending() {
    ...
    r.handle(RouterEvent::Commit { buffer_id: 1 });
    r.handle(RouterEvent::Commit { buffer_id: 2 });
    ...
    let a4 = r.handle(RouterEvent::Commit { buffer_id: 4 });
...
fn app_connected_clears_registry() {
    ...
    let a2 = r.handle(RouterEvent::Commit { buffer_id: 1 });
    ...
    let a2b = r.handle(RouterEvent::Commit { buffer_id: 1 });
    ...
    let a3 = r.handle(RouterEvent::Commit { buffer_id: 1 });
...
fn headless_drain_discards_without_app() {
    let mut r = FrameRouter::new();
    let actions = r.handle(RouterEvent::Commit { buffer_id: 1 });
...
fn cumulative_ack_releases_up_to_serial() {
    ...
    r.handle(RouterEvent::Commit { buffer_id: 1 }); // s1
    r.handle(RouterEvent::Commit { buffer_id: 2 }); // s2
...
fn serial_monotonic() {
    ...
    let _ = r.handle(RouterEvent::Commit { buffer_id: 1 });
